...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        products = [
            {
                "name": "Горох",
                "description": "Содержит большое количество биологически активных соединений.",
                "category": category,
                "price": 100,
            },
            {
                "name": "Фасоль",
                "description": "Аминокислота аргинин необходима для азотистого обмена, снижает в крови уровень глюкозы.",
                "category": category,
                "price": 80,
            },
